...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("O resultado da área do cálculo foi de " + geometricForm.getArea());
        }
    }

    private static GeometricForm createSquare() {
        System.out.println("Informa os tamanhos dos lados: ");
    ...
    private static GeometricForm createCircle() {
        System.out.println("Informa os tamanhos o raios: ");
